...
```{r, echo=FALSE}
table <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/WT_F_L2/Depol.txt",
                   header=T,
                   sep='\t',
                   stringsAsFactors=T)
...
```{r, echo=FALSE}
table2 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/WT_M_L2/Depol.txt", 
                    header=T,
                    sep='\t',
                    stringsAsFactors=T)
...
table2$group <- factor("WT_M_L2")
head(table2)
```

```{r, echo=FALSE}
table3 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/KO_F_L2/Depol.txt", 
                    header=T,
                    sep='\t',
                    stringsAsFactors=T)
...
```{r, echo=FALSE}
table4 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/KO_M_L2/Depol.txt", 
                    header=T,
                    sep='\t',
                    stringsAsFactors=T)
...
ggplot(Summary.df, aes(x=Injected_current, y=NOS, colour=group, palette="npg", group=group)) + 
    ...
    scale_colour_hue(name= "",    # Legend label, use darker colors
                     breaks=c("WT_F_L2", "WT_M_L2", "KO_F_L2", "KO_M_L2"),
                     labels=c("WT_F_L2", "WT_M_L2", "KO_F_L2", "KO_M_L2"),
