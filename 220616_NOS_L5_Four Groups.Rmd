...
```{r, echo=FALSE}
table2 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/WT_M_L5/Depol.txt", 
                    header=T,
                    sep='\t',
                    stringsAsFactors=T)
...
```{r, echo=FALSE}
table4 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/KO_M_L5/Depol.txt", 
                    header=T,
                    sep='\t',
                    stringsAsFactors=T)
...
ggplot(Summary.df, aes(x=Injected_current, y=NOS, colour=group, palette="npg", group=group)) + 
    ...
    scale_colour_hue(name= "",    # Legend label, use darker colors
                     breaks=c("WT_F_L5", "WT_M_L5", "KO_F_L5", "KO_M_L5"),
                     labels=c("WT_F_L5", "WT_M_L5", "KO_F_L5", "KO_M_L5"),
