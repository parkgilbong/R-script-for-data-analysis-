...
```{r echo=FALSE}
AP <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/WT_F_L2/AP analysis.txt",
                   header=T,
                   sep='\t',
                   stringsAsFactors=T)
...
AP2 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/WT_M_L2/AP analysis.txt",
                   header=T,
                   sep='\t',
                   stringsAsFactors=T)
AP2$group <- factor("WT_M_L2")
AP3 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/KO_F_L2/AP analysis.txt",
                   header=T,
                   sep='\t',
                   stringsAsFactors=T)
AP3$group <- factor("KO_F_L2")
AP4 <- read.delim(file="C:/Users/KimYG/Desktop/3. CHD8/IE/Summary/KO_M_L2/AP analysis.txt",
                   header=T,
                   sep='\t',
                   stringsAsFactors=T)
AP4$group <- factor("KO_M_L2")
